...
create_clock -name {GPIO[21]} -period 1.000 -waveform { 0.000 0.500 } [get_ports {GPIO[21]}]
create_clock -name {FSM:u_FSM|reset} -period 1.000 -waveform { 0.000 0.500 } [get_registers {FSM:u_FSM|reset}]
...
set_clock_uncertainty -rise_from [get_clocks {clk_50}] -rise_to [get_clocks {FSM:u_FSM|reset}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {clk_50}] -fall_to [get_clocks {FSM:u_FSM|reset}]  0.030  
...
set_clock_uncertainty -fall_from [get_clocks {clk_50}] -rise_to [get_clocks {FSM:u_FSM|reset}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {clk_50}] -fall_to [get_clocks {FSM:u_FSM|reset}]  0.030  
...
set_clock_uncertainty -rise_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -rise_to [get_clocks {FSM:u_FSM|reset}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -rise_to [get_clocks {FSM:u_FSM|reset}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -fall_to [get_clocks {FSM:u_FSM|reset}] -setup 0.100  
set_clock_uncertainty -rise_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -fall_to [get_clocks {FSM:u_FSM|reset}] -hold 0.070  
...
set_clock_uncertainty -fall_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -rise_to [get_clocks {FSM:u_FSM|reset}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -rise_to [get_clocks {FSM:u_FSM|reset}] -hold 0.070  
set_clock_uncertainty -fall_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -fall_to [get_clocks {FSM:u_FSM|reset}] -setup 0.100  
set_clock_uncertainty -fall_from [get_clocks {Inst_vga_pll|altpll_component|auto_generated|pll1|clk[1]}] -fall_to [get_clocks {FSM:u_FSM|reset}] -hold 0.070  
set_clock_uncertainty -rise_from [get_clocks {FSM:u_FSM|reset}] -rise_to [get_clocks {clk_50}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {FSM:u_FSM|reset}] -fall_to [get_clocks {clk_50}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {FSM:u_FSM|reset}] -rise_to [get_clocks {clk_50}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {FSM:u_FSM|reset}] -fall_to [get_clocks {clk_50}]  0.030  
